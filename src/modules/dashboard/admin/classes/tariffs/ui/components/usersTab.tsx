...
const UsersTab = () => {
  return (
    <div className="grid gap-6">
      <Tabs defaultValue="with-tariffs" className="md:w-full w-[360px]">
        ...
        <TabsContent value="with-tariffs" className="mt-4 w-full">
          <TariffsTab />
        </TabsContent>

        <TabsContent value="with-bonos" className="mt-4 w-full">
          <Section icon={TicketPercent} title="Atletas con Bonos">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between w-full">
              <div className="flex flex-wrap w-full md:max-w-md items-center gap-2">
        ...
        <TabsContent value="inactive" className="mt-4 w-full">
