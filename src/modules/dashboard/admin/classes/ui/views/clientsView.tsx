...
export const ClientsView = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4 w-full md:min-h-screen h-auto pb-20">
      ...
      <div className="md:space-y-4">
        ...
        <Card className="h-auto flex flex-col">
          <CardHeader>
            <div className="flex items-center flex-wrap justify-between gap-5 md:gap-2">
              {/* Day and arrows */}
